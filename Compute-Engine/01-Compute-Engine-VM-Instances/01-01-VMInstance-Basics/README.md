...
3. SSH Keys transferred to VM
4. Verify in `.ssh/authorized_keys` file
5. We will talk more about `SSH Keys` in that respective demo in detail with all options
...
## Step 05-01 — Fix Windows line endings:-
  sed -i 's/\r$//' webserver-install.sh
## Step 05-02 — Give execute permission
  chmod 755 webserver-install.sh
## Step 05-03 — Run
  ./webserver-install.sh

## Need to upload this script
```t
#!/bin/bash
...
HOSTNAME=$(hostname)
sudo echo "<!DOCTYPE html> <html> <body style='background-color:rgb(250, 210, 210);'> <h1>Welcome to Harvindar Singh - WebVM App1 </h1> <p><strong>VM Hostname:</strong> $HOSTNAME</p> <p><strong>VM IP Address:</strong> $(hostname -I)</p> <p><strong>Application Version:</strong> V1</p> <p>Google Cloud Platform - Demos</p> </body></html>" | sudo tee /var/www/html/index.html
```
...
11. Best fix for your GCP labs

## Step-07: Upload and Run the webserver install script

**Best fix for your GCP labs**
